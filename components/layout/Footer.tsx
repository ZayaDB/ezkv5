        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl overflow-hidden ring-1 ring-gray-700/80 bg-white shadow-lg">
                <Image
                  src="/logo/logo.png"
                  alt="logo"
                  width={48}
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link href={getLocalizedPath('/my/inquiries')} className="hover:text-white transition-colors">
                  {t('contactUs')}
                </Link>
              </li>
            </ul>
