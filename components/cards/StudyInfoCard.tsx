...
export default function StudyInfoCard({ info }: StudyInfoCardProps) {
  ...
  return (
    <article
      id={`article-${info.id}`}
      className="group bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden scroll-mt-28"
    >
      {/* Gradient accent bar */}
      ...
      <div className="relative">
        ...
        <p className="text-gray-600 mb-5 line-clamp-6 leading-relaxed whitespace-pre-line">
          {info.content}
        </p>
