...
import { communityApi, enrollmentApi, freelancerApi, mentorsApi, sessionApi } from "@/lib/api";
import Toast from "@/components/ui/Toast";
import SummaryCards from "@/components/dashboard/SummaryCards";
import ModeQuickLinksPanel from "@/components/dashboard/ModeQuickLinksPanel";
import ModeSidePanel from "@/components/dashboard/ModeSidePanel";
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        <SummaryCards
          ...
          numberFormatter={(value) => fmt.number(value)}
        />

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <ModeQuickLinksPanel mode={mode} locale={locale} userRole={user.role} t={t} />
          <ModeSidePanel
            mode={mode}
            locale={locale}
            t={t}
            ...
            labelEnrollment={labelEnrollment}
            labelSession={labelSession}
            onSessionStatus={(id, status) => void handleSessionStatus(id, status)}
