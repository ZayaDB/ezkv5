...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      bio: mentorData.bio,
      sessionDuration: mentorData.sessionDuration,
      sessionFormat: mentorData.sessionFormat,
      yearsOfExperience: mentorData.yearsOfExperience,
      education: mentorData.education,
      careerSummary: mentorData.careerSummary,
      responseTime: mentorData.responseTime,
      timezone: mentorData.timezone,
      introVideoUrl: mentorData.introVideoUrl,
      portfolioLinks: mentorData.portfolioLinks,
      mentoringStyle: mentorData.mentoringStyle,
      recommendedFor: mentorData.recommendedFor,
      notRecommendedFor: mentorData.notRecommendedFor,
